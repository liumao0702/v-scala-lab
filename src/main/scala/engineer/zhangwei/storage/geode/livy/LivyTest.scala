...
object WordCountApp {
  ...
  def uploadRelevantJarsForJobExecution(): Unit = {
    val exampleAppJarPath = "E:\\Project\\v-spark-learning-example\\spark-dev\\sparktrain\\target\\sparktrain-1.0-SNAPSHOT.jar"
  ...
  def main(args: Array[String]): Unit = {
    var socketStreamHost: String = "bg-demo-01.haiyi.com"
